...
enter_or_empty = 'Введите новые значения или оставьте пустым для ' \
                 'сохранения оригинального значения'
...
no_saved_book = 'В вашей телефонной книге есть ' \
                'несохраненные изменения! Сохранить?'
